...
if("TRUE" STREQUAL "TRUE")
  set(perception_SOURCE_PREFIX /fetch_ws/src/fetch-picker/perception)
  set(perception_DEVEL_PREFIX /fetch_ws/devel/.private/perception)
  ...
  set(perception_INSTALL_PREFIX /fetch_ws/install)
...
if(NOT "/fetch_ws/src/fetch-picker/perception/include " STREQUAL " ")
  set(perception_INCLUDE_DIRS "")
  set(_include_dirs "/fetch_ws/src/fetch-picker/perception/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'perception' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/fetch_ws/src/fetch-picker/perception/${idir}'.  ${_report}")
    endif()
    _list_append_unique(perception_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "perception_crop;perception_downsample")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /fetch_ws/devel/.private/perception/lib;/fetch_ws/devel/lib;/opt/ros/noetic/lib)
