...
if("TRUE" STREQUAL "TRUE")
  set(robot_api_SOURCE_PREFIX /fetch_ws/src/fetch-picker/robot_api)
  set(robot_api_DEVEL_PREFIX /fetch_ws/devel/.private/robot_api)
  ...
  set(robot_api_INSTALL_PREFIX /fetch_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robot_api' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'robot_api' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/fetch_ws/src/fetch-picker/robot_api/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT robot_api_NUM_DUMMY_TARGETS)
      set(robot_api_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::robot_api::wrapped-linker-option${robot_api_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR robot_api_NUM_DUMMY_TARGETS "${robot_api_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::robot_api::wrapped-linker-option${robot_api_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND robot_api_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /fetch_ws/devel/.private/robot_api/lib;/fetch_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${robot_api_dep}_FOUND)
      find_package(${robot_api_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${robot_api_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(robot_api_EXPORTED_TARGETS ${${robot_api_dep}_EXPORTED_TARGETS})
endforeach()
